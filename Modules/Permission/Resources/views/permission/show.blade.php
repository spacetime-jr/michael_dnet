...
@section('content')
    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h4><a href="{{!empty(\URL::previous())?\URL::previous():route('dashboard')}}"><i class="icon-arrow-left52 position-left" style="color: #000;"></i></a> <span class="text-semibold">Reference</span> Detail
                </h4>
            </div>
        </div>
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="active">Reference Detail</li>
            </ul>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="content">
        <div class="panel" style="background-color: transparent; border:0; box-shadow: none;">
            @if(\Sentinel::getUser()->hasAccess('reference.create'))
            ...
            @if(\Sentinel::getUser()->hasAccess('reference.edit'))
            ...
            @if(\Sentinel::getUser()->hasAccess('reference.delete'))
                <a href="{{route('reference.delete', $reference->id)}}" class="confirmAction">
                ...
                <div class="form-horizontal">
                    <fieldset class="content-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="control-label col-lg-10">
                                {{date('j M Y h:i a',strtotime($reference->created_at))}}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="control-label col-lg-10">
                                {{date('j M Y h:i a',strtotime($reference->updated_at))}}
                            </div>
                        </div>
